...
from app.api.endpoints import auth, buildings, maintenance, payments, documents, communication, notifications
...
app.include_router(communication.router, prefix=f"{settings.API_V1_STR}", tags=["Communication & Chat", "Visits", "Chatbot"])
